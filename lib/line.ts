 ...
 */
function* line_approx(x: number, y: number): Generator<
    gp['cursor'], undefined, undefined
> {
    if (isPrevUnset()) {
        yield { x, y };
    }
 ...
 */
function line(this: gp, cancel?: boolean): void {
